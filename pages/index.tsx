...
const Home: NextPage = () => {
    ...
    const [faq, setFaq] = useState<{ title: string; desc: string; btntext: string; btnhref: string; }[]>([
        { title: "What does Cotidie mean?", desc: "Cotidie is Latin for Daily! That's all it is!", btntext: "Get Started", btnhref: "#"},
        { title: "Why is this free?", desc: "Cotidie was made as a project for Timathon, a Code Jam, so it is a 100% free and open source! So what are you waiting for, get started!", btntext: "Get Started", btnhref: "#" },
        { title: "How does it work?", desc: "Cotidie's algorithm is simple. You give it a list of tasks, the day, and a list of your breaks. Cotidie carefully analyses and plans out you day for you. You can check the complete algorithm on our GitHub!", btntext: "GitHub", btnhref: "https://github.com/Cotidie-project/backend" },
        { title: "How is it different from other day planners?", desc: "Cotidie isn't yet another day planner! It's your daily helper!", btntext: "What are you waiting for?", btnhref: "#" },
    ]);
            ...
            <main className="bg-[#1D1D26] font-[Poppins] h-full text-white">
                ...
                <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
                    <div className="md:flex md:justify-between">
                        <div className="mb-6 md:mb-0">
                            <a href="#" className="flex items-center">
                                <Image src={logo} className="mr-3 h-8" height="40" width="40" alt="Cotidie Logo" />
                                <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">&nbsp;&nbsp;Cotidie</span>
                            </a>
                        </div>
                        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
                            ...
                            <div>
                                ...
                                <ul className="text-gray-600 dark:text-gray-400">
                                    <li className="mb-4">
                                        <a href="https://github.com/Cotidie-project" className="hover:underline ">Github</a>
                                    </li>
                                    <li>
                                        <a href="https://discord.gg/KYH4Y8aktx" className="hover:underline">Discord</a>
                                    </li>
                                </ul>
                            </div>
                            <div>
                                <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Code Jam</h2>
                                <ul className="text-gray-600 dark:text-gray-400">
                                    <li className="mb-4">
                                        <a href="https://twtcodejam.net/timathon/" className="hover:underline">Timathon</a>
                                    </li>
                                    <li>
                                        <a href="https://twtcodejam.net/timathon/team/1424" className="hover:underline">Our Team</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="#" className="hover:underline">Cotidie &amp; Contributors</a>. All Rights Reserved.
                        </span>
                        <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0"> 
                            <a href="https://github.com/Cotidie-project" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
